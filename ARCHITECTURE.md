# Architecture Specification: UniERP Cryptographic Audit & Ledger Proof (`blockchain`)
...
```mermaid
graph LR
  Callers["Allowed Inbound Callers<br/>L3 (api)"] --> Repo["<b>blockchain (L2)</b><br/>UniERP Cryptographic Audit & Ledger Proof"]
...
- **Core Runtime & Languages**: TypeScript, Node Crypto, Vitest
- **Primary Interface**: `@kannan19302/blockchain`
...
- **Project Skill**: [`.agents/skills/blockchain-standards/SKILL.md`](.agents/skills/blockchain-standards/SKILL.md)
